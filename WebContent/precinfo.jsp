			...
			<div class="row wrapper">
				<div class="row info">
					<div class="col col-12 label">
						<span class="badge badge-primary">판례</span>
					</div>
					<div class="col col-12 info-name">
						<span><b>${precName }</b></span> 의 검색 결과
					</div>
				...
				<div class="row prec-contents">
					<div class="col col-12 precsection">
						<b>판시 사항</b>
					</div>
					<div class="col col-12 precissue">${precIssue }</div>
					<div class="col col-12 precsection">
						<b>판결 요지</b>
					</div>
					<div class="col col-12">${precCon }</div>
					<div class="col col-12 precsection">
						<b>참조 조문</b>
					</div>
					<div class="col col-12 preclaw">${precLaw }</div>
					<div class="col col-12 precsection">
						<b>판례 내용</b>
					</div>
					<div class="col col-12 preccontent">${precContent }</div>
				</div>
