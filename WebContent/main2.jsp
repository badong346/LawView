                				...
                				$.ajax({
                						...
                						.done(
                								function(resp) {
                									...
                									$("#lawyer1name").html("<a href='toProfile.profile?seq="
                											+ resp[0].seq
                											+ "'>"
                											+ resp[0].name + "</a>");
                									 <%-- 프로필 이미지 없는 경우 디폴트사진 출력 --%>
                									if(resp[0].img == null){
                										var insImg1 =" <a href='toProfile.profile?seq="+resp[0].seq+"'><img src='${pageContext.request.contextPath}/upload/default.webp' class='card-img'></a> ";
                									}else{
                										var insImg1 =" <a href='toProfile.profile?seq="+resp[0].seq+"'><img src='${pageContext.request.contextPath}/upload/"+resp[0].img+"' class='card-img'></a> ";
                									}
                									...
                									$("#lawyer2name").html("<a href='toProfile.profile?seq="
                											+ resp[1].seq
                											+ "'>"
                											+ resp[1].name + "</a>");
                									if(resp[1].img == null){
                										var insImg1 =" <a href='toProfile.profile?seq="+resp[1].seq+"'><img src='${pageContext.request.contextPath}/upload/default.webp' class='card-img'></a> ";
                									}else{
                										var insImg1 =" <a href='toProfile.profile?seq="+resp[1].seq+"'><img src='${pageContext.request.contextPath}/upload/"+resp[1].img+"' class='card-img'></a> ";
                									}
                	...
                	$.ajax({
                		...
                		console.log(resp);
                   		for(var i = 0; i < resp.length; i++){
                   			...
                   			console.log(Math.ceil((Now.getTime()-WriteDate.getTime())/(1000*3600*24))); 
                   			var anc = $("<a></a>");
                   			anc.prop("href","contents.req?seq="+resp[i].seq);
                   			anc.text(resp[i].title);
                   			line.append(anc);
                   			if((Math.ceil((Now.getTime()-WriteDate.getTime())/(1000*3600*24))) <= 2){
                       			var span = $("<span></span>");
                       			span.addClass("badge");
                       			span.text("new");
                       			line.append(span);
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" id="lawyer1title">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" id="lawyer2title">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                        </div>
                                    </div>
